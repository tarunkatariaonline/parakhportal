  ...
  const QuestionAnalysisCard = ({ correctAnswers, incorrectAnswers, skippedQuestions }) => {
    ...
    return (
      <Box
        ...
        boxShadow="md"
        textAlign="left"
        style={{ position: 'relative', margin: 'auto', maxWidth: '600px' }}
      >
        ...
        <HStack spacing={4} style={{ justifyContent: 'center', flexWrap: 'wrap' }}>
    ...
    <>
      ...
      <div className="sidebar" >
        ...
        <ul className="side-menu">
          ...
          <li>
            <a href="/quiz" style={{backgroundColor:"#119af0",color:"white"}}>
        ...
        <main>
          ...
          <HStack h={'120vh'} w={'full'} bgColor={'gray.200'} alignItems={'flex-start'} justifyContent={'flex-start'} flexDir={'column'}>
            ...
            <HStack h={'50px'} bgColor={'white'} w={'full'} justifyContent={'space-between'}>
              <HStack>
                <Button ml={'10px'} borderRightRadius={'10px'} h={'35px'} bgColor={'#119af0'} color={"white"}>
                  Topics
                </Button>
                <Text color={'blue.400'} mt={"13px"} fontSize={'28px'} fontWeight={'bold'}>
                  {`>`}
                </Text>

                <Button borderRightRadius={'10px'} h={'35px'} color={"white"} bgColor={'#119af0'}>
                  Engineering
                </Button>
              </HStack>
                ...
                <HStack w={'95%'} h={'full'}>
                  <HStack w={'70%'} h={'full'} flexDir={'column'} alignItems={'flex-start'}>
                    ...
                    <HStack w={'full'} h={'80px'} mt={'20px'}>
                      <Button fontSize={'11px'} color={'white'} bgColor={'yellow.400'} w={'150px'}  onClick={handlePrevious}>
                        Previous
                      </Button>
                      {/* <Button fontSize={'13px'} w={'150px'} border={'1px solid blue'} borderRadius={'0px'}>
                                                Close
                                            </Button> */}
                      <Button fontSize={'11px'} color={'white'} bgColor={'red.600'} w={'170px'}  onClick={handleSkipAndAnswerLater}>
                        Skip & Answer Later({skippedQuestions.length})
                      </Button>
                      <Button fontSize={'11px'} color={'white'} bgColor={'yellow.500'} w={'170px'}  onClick={handleSaveAndReviewLater}>
                        Save & Review Later (1)
                      </Button>
                      <Button fontSize={'11px'} color={'white'} bgColor={'green.500'} w={'170px'}  onClick={handleSaveAndNext}>
                        Save & Next(1)
                      </Button>
                      <Button colorScheme="orange"  fontSize={"11px"} mr={'20px'} onClick={handleOpenConfirmationModal}>
                        SUBMIT
                      </Button>
                  ...
                  <HStack w={'30%'} bgColor={'white'} flexDir={"column"}>
